  ...
  const leadership = [
    ...
    return (
      <div className="flex flex-col min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-100">
        ...
        <HeroSection
          short
          title="About VehiclesData"
          subtitle="VehiclesData empowers developers and enthusiasts with modern tools and insights to understand vehicle information more effectively."
          showCTA={false}
        />
